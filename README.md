...
[**Download Vollo 0.1.0 for Android (versionCode 12)**](https://github.com/SHTG1itch/Vollo/releases/download/v0.1.0-android.12/Vollo-0.1.0-android-v12.apk)

- Requires Android 7.0 (API 24) or newer.
- Package: `app.vollo.mobile`
- SHA-256: `3F3B45102FEC33E3AABA2D7A5F41F4F71F971D6F9DE18FA75C7C4F2108E29822`
...
```text
3F3B45102FEC33E3AABA2D7A5F41F4F71F971D6F9DE18FA75C7C4F2108E29822  Vollo-0.1.0-android-v12.apk
```
