...
function mapMatchBase(r: Record<string, unknown>): Match {
  return {
    ...
    match_format: (r.match_format as Match['match_format']) ?? 'singles',
    partner_id: (r.partner_id as string | null) ?? null,
    partner_name: (r.partner_name as string | null) ?? null,
    opponent_id: (r.opponent_id as string | null) ?? null,
    opponent_name: (r.opponent_name as string | null) ?? null,
    opponent2_id: (r.opponent2_id as string | null) ?? null,
    opponent2_name: (r.opponent2_name as string | null) ?? null,
...
export function mapScheduledMatch(r: Record<string, unknown>, viewerId: string): ScheduledMatchCard {
  return {
    ...
    match_format: (r.match_format as ScheduledMatchCard['match_format']) ?? 'singles',
    partner_id: (r.partner_id as string | null) ?? null,
    partner_username: (r.partner_username as string | null) ?? null,
    partner_display_name: (r.partner_display_name as string | null) ?? null,
    partner_avatar_url: (r.partner_avatar_url as string | null) ?? null,
    partner_name: (r.partner_name as string | null) ?? null,
    opponent_id: (r.opponent_id as string | null) ?? null,
    ...
    opponent_name: (r.opponent_name as string | null) ?? null,
    opponent2_id: (r.opponent2_id as string | null) ?? null,
    opponent2_username: (r.opponent2_username as string | null) ?? null,
    opponent2_display_name: (r.opponent2_display_name as string | null) ?? null,
    opponent2_avatar_url: (r.opponent2_avatar_url as string | null) ?? null,
    opponent2_name: (r.opponent2_name as string | null) ?? null,
    court_id: (r.court_id as string | null) ?? null,
    ...
    viewer_role: (r.creator_id as string) === viewerId || (r.partner_id as string | null) === viewerId ? 'creator' : 'opponent',
    created_at: toIso(r.created_at),
  };
}
