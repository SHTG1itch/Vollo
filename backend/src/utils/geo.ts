...
// compass direction, and unit-test the geometry without a live database.
 ...
 *
 * This implements the spec's "courts within a 10km radius" grouping. Because it
 * is transitive (single-linkage), a chain of nearby courts forms one district —
 * which is exactly how sprawling real-world territories behave.
 */
 ...
 * value authoritatively; this is a fallback and a test aid.
 * `ring` is an ordered list of vertices (not necessarily closed).
 */
 ...
 * in production; this mirror exists so the geometry is unit-testable offline and
 * documents exactly which points the hull will retain.
