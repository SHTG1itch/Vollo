...
import { centroid, clusterByRadius, districtName, type LatLng } from '../utils/geo.js';
import { notify } from './notifications.js';
import type { GeoJsonPolygon, Territory } from '../types/index.js';
...
/**
 * Run the PostGIS convex-hull computation over a set of courts, exactly as the
 * spec prescribes:
 ...
 *   - anyone whose existing territory still references that court (so a
 *     dethroned controller's polygon contracts/shatters in real time).
